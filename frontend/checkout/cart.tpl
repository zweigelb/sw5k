...
{block name='frontend_index_content'}
    <div class="content content--basket content--checkout">
        ...
        {* Maximum sum exceeded *}
        {block name='frontend_checkout_error_messages_maximum_sum_exceeded'}
            {if $nxsMaximumOrderQuantityExceeded}
                {include file="frontend/_includes/messages.tpl" type="error" content="{"{s name='nxsMaximumOrderQuantityExceeded'}{/s}"|replace:'%w':$nxsMaximumOrderQuantityExceeded}"}
        ...
        {else}
            ...
            {block name='frontend_basket_basket_is_empty'}
                <div class="basket--info-messages basket--info-messages-nxs">
                    <p>{s name='CartInfoEmpty'}{/s}</p>
                    <img src="{link file='frontend/_public/src/images/empty_basket.png'}" alt="{s name='CartInfoEmpty'}{/s}">
                </div>
            {/block}
        {/if}
    </div>
