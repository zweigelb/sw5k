...
{block name="frontend_index_header_favicons"}
    ...
    <link rel="shortcut icon" href="{link file='frontend/_public/src/images/favicon.ico'}">
{/block}
...
{block name="frontend_index_header_javascript_fonts"}
    <script src="https://use.typekit.net/vtd7cmk.js"></script>
